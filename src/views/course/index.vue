...
export default {
    data() {
        return {
            ...
            data: [
                {courseId: 123, title: '你好', cateName: '语言留学', type: '直播课', status: '上架中', teacher: 'livetest006', price: 0, stuNum: 200},
                {courseId: 222, title: '你好', cateName: '语言留学', type: '直播课', status: '上架中', teacher: 'livetest006', price: 123, stuNum: 200}
            ]
        }
    },
    components: {
